      ...
      <div className='flex flex-1 justify-center items-center h-screen w-full'>
        <div className='w-full pr-10 pl-10 xl:pr-40 xl:pl-40 md:pr-30 md:pl-30'>
          ...
          <div className='flex gap-2'>
            ...
            <Input id='dayofbirth' type='date' title='Day of birth' className='w-[50%]' />
          </div>

          <div className='flex gap-2'>
            <Input id='email' type='email' title='Email' />
            <Input id='phone' type='phone' title='Phone number' className='w-[50%]' />
          </div>

          <Input id='username' type='text' title='Username' />
          <Input id='password' type='password' title='Password' />
          <Input id='confirm' type='password' title='Confirm password' />
          ...
          <div className='flex justify-center items-center mb-6'>
            <div className='flex grow'>
              ...
              <h3 className=' font-normal ml-2 text-xs text-[#FA837F] cursor-pointer'>Privacy Polices</h3>
            </div>
          </div>
          ...
          <div className='flex mt-5'>
            ...
            <h1 className='ml-3 mr-3 text-gray-400 text-[14px]'>Or sign up with</h1>
            <div className='border-t-2 grow mt-3'></div>
          </div>
