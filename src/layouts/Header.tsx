      ...
      <nav className='bg-black border-gray-200 dark:bg-gray-900'>
        <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
          <ul className='flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  md:dark:bg-gray-900 '>
            ...
            <li>
              <a href='#' className='flex flex-row gap-1 py-2 px-3 md:p-0 text-white rounded hover:text-[#8DD3BB]'>
          ...
          <div className='flex gap-2 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse'>
            <button
              type='button'
              className='text-white bg-transparent hover:text-[#8DD3BB]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center'
            >
              Login
            </button>
            <button
              type='button'
              className='text-black bg-white hover:bg-[#8DD3BB] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center'
            >
              Sign Up
            </button>
            <button
